    ...
    <table valign="top">
        <tbody>
            ...
            <tr>
                <td colspan="2"> <center> 
                    <?php
                        echo CHtml::ajaxSubmitButton('Показати', array('AirMarker/ChartData'), array('type' => 'POST', 'update' => '#content'), array('class' => 'sbmt', 'type' => 'submit'));
                    ?> 
                </center> </td> 
        </tr>
    ...
    <table>
        <tbody>
            ...
            <tr>
                <td colspan="2"> <center> 
                    <?php
                         echo CHtml::ajaxSubmitButton('Показати', array('AirMarker/ChartMultiData'), array('type' => 'POST', 'update' => '#content'), array('class' => 'sbmt', 'type' => 'submit'));
                    ?> 
                </center> </td> 
        </tr>
