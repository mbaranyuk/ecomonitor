...
<div class="sidebar_form">
    ...
    <table valign="top">
        <tbody>
            ...
            <tr> <td> <?= CHtml::hiddenField('id', $this->marker_id); ?> </td> </tr>
            <tr>
                <td colspan="2"> <center> 
                    <?php
                        echo CHtml::ajaxSubmitButton('Показати', array('WaterMarker/ChartData'), array('type' => 'POST', 'update' => '#content'), array('class' => 'sbmt', 'type' => 'submit'));
                    ?> 
                </center> </td> 
        </tr>
    ...
    <table>
        <tbody>
            ...
            <tr>
                <td colspan="2"> <center> 
                    <?php
                         echo CHtml::ajaxSubmitButton('Показати', array('WaterMarker/ChartMultiData'), array('type' => 'POST', 'update' => '#content'), array('class' => 'sbmt', 'type' => 'submit'));
                    ?> 
                </center> </td> 
        </tr>
