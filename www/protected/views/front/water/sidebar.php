...
<div class="sidebar_form">
    <?php echo CHtml::form(); ?>
    <div class="form_caption"> Графік значень показника </div>
    <table valign="top">
        <tbody>
            <tr>
            ...
            <tr>
                <td colspan="2"> <center> 
                    <?php
                        echo CHtml::ajaxSubmitButton('Показати', array('Water/ChartData'), array('type' => 'POST', 'update' => '#content'), array('class' => 'sbmt', 'type' => 'submit'));
                    ?> 
                </center> </td> 
        </tr>
...
<div class="sidebar_form">
    <?php echo CHtml::form(); ?>
    <div class="form_caption"> Графік залежності показників </div>
    <table>
        <tbody>
            <tr>
                <td>Показник:</td> 
            ...
            <tr>
                <td colspan="2"> <center> 
                    <?php
                         echo CHtml::ajaxSubmitButton('Показати', array('Water/ChartMultiData'), array('type' => 'POST', 'update' => '#content'), array('class' => 'sbmt', 'type' => 'submit'));
                    ?> 
                </center> </td> 
        </tr>
...
<div class="sidebar_form" id="table_f">
    <?php echo CHtml::form(); ?>
    <div class="form_caption"> Таблиця спостережень за станом показників  </div>
    <table>
        <tbody>
            <tr>
